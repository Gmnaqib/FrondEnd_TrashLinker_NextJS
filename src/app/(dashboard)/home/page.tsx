...
export default function page() {
  ...
  const items = [
    { id: 1, name: "Item 1", point: 100, rank: 1 },
    { id: 2, name: "Item 2", point: 90, rank: 2 },
    { id: 3, name: "Item 3", point: 80, rank: 3 },
    { id: 4, name: "Item 4", point: 70, rank: 4 },
    { id: 5, name: "Item 5", point: 60, rank: 5 },
    { id: 6, name: "Item 6", point: 50, rank: 6 },
    { id: 7, name: "Item 6", point: 50, rank: 6 },
    { id: 8, name: "Item 6", point: 50, rank: 6 },
    { id: 9, name: "Item 6", point: 50, rank: 6 },
  ];
