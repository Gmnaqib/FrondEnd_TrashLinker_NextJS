    ...
    <div>
      <div className="flex flex-col items-center">
        ...
        <div className="bg-black grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 p-10">
          ...
          <FeatureCard icon="icon_komunitas.svg" fitur="Kolaborasikomunitas" description="Pengguna dan komunitas dapat berkolaborasi untuk membersihkan area yang dilaporkan." />
